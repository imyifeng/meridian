  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (widget.memo == null) {
        ...
        // Where the reminder UI is hidden the save omits the field: the
        // server keeps the standing reminder instead of this editor's
        // possibly stale load overwriting a concurrent change.
